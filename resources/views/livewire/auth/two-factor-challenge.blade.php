                        ...
                        <div class="flex items-center justify-center my-5">
                            <div class="w-full">
                                ...
                                <input
                                    ...
                                    placeholder="123456"
                                    class="h-11 w-full rounded-lg border border-zinc-200 bg-white px-3 text-center text-base tracking-widest text-zinc-900 shadow-sm outline-none ring-offset-2 focus:ring-2 focus:ring-brand-600"
                                />
                                @error('code')
